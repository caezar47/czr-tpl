...
// gulp.task('dev:favicon', function(done) {
// 	realFavicon.generateFavicon({
// 		//masterPicture: gulp.src(path.src.favicon + "/*.{png,jpg}"),
// 		masterPicture: gulp.src(path.src.favicon + "/*.png"),
// 		dest: path.build.favicon,
// 		iconsPath: "/wp-content/themes/azbnbasetheme/favicon" ,
// 		design: {
// 			ios: {
